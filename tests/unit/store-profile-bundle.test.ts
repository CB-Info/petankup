...
// Tests de l'action loadUserProfile du store tournament (Phase J).
//
...
describe('useTournamentStore — loadUserProfile', () => {
...
describe('useTournamentStore — profile bundle reset on logout', () => {
